...
const SKILL_CONFIG = [
  { key: 'communication',      label: 'Communication',      color: '#deb7ff' },
  { key: 'product_knowledge',  label: 'Product Knowledge',  color: '#e9c46a' },
  { key: 'objection_handling', label: 'Objection Handling', color: '#ffb4ab' },
  { key: 'rapport',            label: 'Rapport',            color: '#a5d6a7' },
  { key: 'closing',            label: 'Closing',            color: '#b472f1' },
];
  ...
  return (
    <div className="flex flex-col items-center justify-center py-24 text-center">
      <div
        ...
        style={{ background: 'var(--primary-soft)', border: '1px solid rgba(222,183,255,0.2)' }}
      >
        <svg width="24" height="24" fill="none" stroke="var(--primary)" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
        ...
        {loading ? <Spinner /> : !progressData || progressData.total_sessions === 0 ? (
          ...
          <>
            ...
            <div className="flex gap-2 mb-5">
              ...
              <span className="ml-auto text-xs self-center" style={{ color: 'var(--text-subtle)' }}>
