# migrations/env.py
"""
Alembic migration environment for VCAI.

The database URL is loaded from the same application settings as the app
(backend.config.get_settings().database_url) rather than the hardcoded
sqlalchemy.url in alembic.ini, and target_metadata is Base.metadata with all
